...
#define DEFINE_IMAGE( name, initialiser, textual_name )  SAUCEDACITY_DLL_API teBmps name=-1;
#define DEFINE_COLOUR( name, initialiser, textual_name ) SAUCEDACITY_DLL_API int name=-1;
#define DEFINE_FONT( name, initialiser, textual_name )  SAUCEDACITY_DLL_API int name=-1;
