...
struct SAUCEDACITY_DLL_API TrackIntervalData {
...
class SAUCEDACITY_DLL_API Track /* not final */
...
class SAUCEDACITY_DLL_API AudioTrack /* not final */ : public Track
{
public:
   AudioTrack()
      : Track{} {}
...
class SAUCEDACITY_DLL_API PlayableTrack /* not final */ : public AudioTrack
{
public:
   PlayableTrack()
      : AudioTrack{} {}
 ...
 */
class SAUCEDACITY_DLL_API TrackList final
   : public wxEvtHandler
   , public ListOfTracks
