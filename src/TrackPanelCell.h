...
class SAUCEDACITY_DLL_API /* not final */ TrackPanelNode
...
class SAUCEDACITY_DLL_API TrackPanelGroup /* not final */ : public TrackPanelNode
{
public:
   TrackPanelGroup();
...
class SAUCEDACITY_DLL_API TrackPanelCell /* not final */ : public TrackPanelNode
{
public:
