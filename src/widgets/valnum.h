...
class SAUCEDACITY_DLL_API NumValidatorBase /* not final */ : public wxValidator
{
public:
...
class SAUCEDACITY_DLL_API IntegerValidatorBase /* not final */
...
class SAUCEDACITY_DLL_API FloatingPointValidatorBase /* not final */
   : public NumValidatorBase
{
public:
...
SAUCEDACITY_DLL_API double RoundValue(int precision, double value);
