...
public:
   ...
   [[nodiscard]] const AVIOContext* GetWrappedValue() const noexcept;

   virtual ~AVIOContextWrapper();

   OpenResult Open(const wxString& fileName, bool forWriting);

   [[nodiscard]] virtual unsigned char* GetBuffer() const noexcept = 0;
   [[nodiscard]] virtual int GetBufferSize() const noexcept = 0;
   [[nodiscard]] virtual unsigned char* GetBufPtr() const noexcept = 0;
   [[nodiscard]] virtual unsigned char* GetBufEnd() const noexcept = 0;
   ...
   [[nodiscard]] virtual int GetEofReached() const noexcept = 0;

   [[nodiscard]] virtual int GetWriteFlag() const noexcept = 0;
   virtual void SetWriteFlag(int write_flag) noexcept = 0;

   [[nodiscard]] virtual int GetError() const noexcept = 0;
   virtual void SetError(int error) noexcept = 0;

   [[nodiscard]] virtual int GetSeekable() const noexcept = 0;
   virtual void SetSeekable(int seekable) noexcept = 0;

   [[nodiscard]] virtual int GetDirect() const noexcept = 0;
