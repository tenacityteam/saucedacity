...
public:
   ...
   //! @return null if OpenInputContext or OpenOutputContext has not been called
   [[nodiscard]] const AVFormatContext* GetWrappedValue() const noexcept;
   ...
   [[nodiscard]] const AVInputFormatWrapper* GetInputFormat() const noexcept;
   [[nodiscard]] const AVOutputFormatWrapper* GetOutputFormat() const noexcept;

   virtual void SetOutputFormat(std::unique_ptr<AVOutputFormatWrapper> oformat) noexcept = 0;

   [[nodiscard]] virtual AVIOContextWrapper* GetAVIOContext() const noexcept = 0;
   virtual void SetAVIOContext(std::unique_ptr<AVIOContextWrapper> pb) noexcept = 0;

   [[nodiscard]] virtual int GetCtxFlags() const noexcept = 0;

   [[nodiscard]] virtual unsigned int GetStreamsCount() const noexcept = 0;

   [[nodiscard]] virtual const StreamsList& GetStreams() const noexcept = 0;
   [[nodiscard]] virtual const AVStreamWrapper* GetStream(int index) const noexcept;

   [[nodiscard]] virtual const char* GetFilename() const noexcept = 0;
   ...
   [[nodiscard]] virtual int GetBitRate() const noexcept = 0;
   virtual void SetBitRate(int bit_rate) noexcept = 0;

   [[nodiscard]] virtual unsigned int GetPacketSize() const noexcept = 0;
   virtual void SetPacketSize(unsigned int packet_size) noexcept = 0;

   [[nodiscard]] virtual int GetMaxDelay() const noexcept = 0;
   ...
   [[nodiscard]] virtual unsigned int GetProbeSize() const noexcept = 0;
   virtual void SetProbeSize(unsigned int probesize) noexcept = 0;

   [[nodiscard]] virtual int GetMaxAnalyzeDuration() const noexcept = 0;
   virtual void SetMaxAnalyzeDuration(int max_analyze_duration) noexcept = 0;

   [[nodiscard]] virtual AVCodecIDFwd GetAudioCodecId() const noexcept = 0;
   virtual void SetAudioCodecId(AVCodecIDFwd audio_codec_id) noexcept = 0;

   [[nodiscard]] virtual unsigned int GetMaxIndexSize() const noexcept = 0;
   ...
   [[nodiscard]] virtual int64_t GetStartTimeRealtime() const noexcept = 0;
   virtual void SetStartTimeRealtime(int64_t start_time_realtime) noexcept = 0;

   [[nodiscard]] virtual int GetFpsProbeSize() const noexcept = 0;
   virtual void SetFpsProbeSize(int fps_probe_size) noexcept = 0;

   [[nodiscard]] virtual int GetErrorRecognition() const noexcept = 0;
   virtual void SetErrorRecognition(int error_recognition) noexcept = 0;

   [[nodiscard]] virtual int64_t GetMaxInterleaveDelta() const noexcept = 0;
   virtual void SetMaxInterleaveDelta(int64_t max_interleave_delta) noexcept = 0;

   [[nodiscard]] virtual int GetStrictStdCompliance() const noexcept = 0;
   virtual void SetStrictStdCompliance(int strict_std_compliance) noexcept = 0;

   [[nodiscard]] virtual int GetAudioPreload() const noexcept = 0;
   virtual void SetAudioPreload(int audio_preload) noexcept = 0;

   [[nodiscard]] virtual int GetMaxChunkDuration() const noexcept = 0;
   virtual void SetMaxChunkDuration(int max_chunk_duration) noexcept = 0;

   [[nodiscard]] virtual int GetMaxChunkSize() const noexcept = 0;
   virtual void SetMaxChunkSize(int max_chunk_size) noexcept = 0;

   [[nodiscard]] virtual int GetUseWallclockAsTimestamps() const noexcept = 0;
   virtual void SetUseWallclockAsTimestamps(int use_wallclock_as_timestamps) noexcept = 0;

   [[nodiscard]] virtual int GetAvoidNegativeTs() const noexcept = 0;
   virtual void SetAvoidNegativeTs(int avoid_negative_ts) noexcept = 0;

   [[nodiscard]] virtual int GetAvioFlags() const noexcept = 0;
   virtual void SetAvioFlags(int avio_flags) noexcept = 0;

   [[nodiscard]] virtual int64_t GetSkipInitialBytes() const noexcept = 0;
   virtual void SetSkipInitialBytes(int64_t skip_initial_bytes) noexcept = 0;

   [[nodiscard]] virtual unsigned int GetCorrectTsOverflow() const noexcept = 0;
   virtual void SetCorrectTsOverflow(unsigned int correct_ts_overflow) noexcept = 0;

   [[nodiscard]] virtual int GetSeek2any() const noexcept = 0;
   virtual void SetSeek2any(int seek2any) noexcept = 0;

   [[nodiscard]] virtual int GetFlushPackets() const noexcept = 0;
   virtual void SetFlushPackets(int flush_packets) noexcept = 0;

   [[nodiscard]] virtual int GetProbeScore() const noexcept = 0;

   [[nodiscard]] virtual int GetFormatProbeSize() const noexcept = 0;
   virtual void SetFormatProbeSize(int format_probesize) noexcept = 0;

   [[nodiscard]] virtual AVCodecWrapper* GetAudioCodec() const noexcept = 0;
   ...
   [[nodiscard]] virtual int64_t GetOutputTsOffset() const noexcept = 0;
   virtual void SetOutputTsOffset(int64_t output_ts_offset) noexcept = 0;
protected:
   [[nodiscard]] virtual AVInputFormat* GetIFormat() const noexcept = 0;
   [[nodiscard]] virtual AVOutputFormat* GetOFormat() const noexcept = 0;
